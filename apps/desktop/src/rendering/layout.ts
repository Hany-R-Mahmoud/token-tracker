...
import type { DesktopRuntimeStatus } from "../runtime/runtime-status.js";
...
export function buildDesktopNav(
  active: DesktopSurface,
  options: { showRefreshIndicator?: boolean } = {},
): string {
...
export function buildRuntimeDiagnosticsHtml(
  runtimeStatus: DesktopRuntimeStatus,
): string {
