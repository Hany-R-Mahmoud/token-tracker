...
- **Files:** 
  - `apps/web/src/index.ts` - rate limiting with 60 requests/minute per IP
  - `apps/desktop/src/index.ts` - rate limiting with 60 requests/minute per IP
- **Implementation:** In-memory sliding window rate limiter with automatic cleanup
...
2. **Web Rate Limiting:**
   - [apps/web/src/index.ts#L18-26](/Users/hanyramadan/token%20traker/apps/web/src/index.ts#L18-26)
   - [apps/web/src/index.ts#L721-750](/Users/hanyramadan/token%20traker/apps/web/src/index.ts#L721-750)

3. **Desktop Rate Limiting:**
   - [apps/desktop/src/index.ts#L23-31](/Users/hanyramadan/token%20traker/apps/desktop/src/index.ts#L23-31)
   - [apps/desktop/src/index.ts#L784-815](/Users/hanyramadan/token%20traker/apps/desktop/src/index.ts#L784-815)

4. **Core DB Path Validation:**
   - [packages/core/src/db/database.ts#L777-827](/Users/hanyramadan/token%20traker/packages/core/src/db/database.ts#L777-827)

5. **Leaderboard DB Path Validation:**
   - [apps/web/src/db.ts#L518-561](/Users/hanyramadan/token%20traker/apps/web/src/db.ts#L518-561)

6. **CLI Export Path Validation:**
   - [packages/cli/src/index.ts#L655-690](/Users/hanyramadan/token%20traker/packages/cli/src/index.ts#L655-690)

7. **Tauri API Key Sending:**
...
- ✅ Added HTTP rate limiting to web and desktop apps (M3)
